...
<div class="top-banner-container" style="background-image:url('<?=get_stylesheet_directory_uri()?>/assets/img/home/banner-top.png');">
	<img src="<?=get_stylesheet_directory_uri()?>/assets/img/home/banner-top.png" class="img-responsive hidden-xs hidden-sm visible-md visible-lg" />
</div>
		...
		<div class="content-right col-md-12">
			...
			<div class="scrollable-content-wrapper">
				<div class="scrollable-content">
					<div class="news-item">
						<div class="news-date">16th Oct 2018</div>
						<div class="news-content">
							<p>The following resource is uploaded.</p>
							<p>Teacher's Web Support:</p>
							<p>Assessment Resources</p>
							<ul>
								<li><a href="#">Question Bank Updates 2015 (1A, 2A)</a></li>
							</ul>
						</div>
					</div>
					<div class="news-item">
