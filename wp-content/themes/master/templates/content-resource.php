					...
					<div class="multiple_download">
						...
						<div class="multiple_dl_content">
							<ul>
								...
								<li><a href="javascript:;" data-file="/wp-content/themes/master/assets/img/common/multiiple@2x.png,/wp-content/themes/master/assets/img/common/img_single_image.png,/wp-content/themes/master/assets/img/common/surroundTestDTS.dts.wav,/wp-content/themes/master/assets/img/common/img_video.png,/wp-content/themes/master/assets/img/common/sample.wav" data-filename="testing456" class="createzip">Download All (5 files)</a></li>
							</ul>
						</div>
					</div>
				</div>
